...
We simulate design variables for lung function (ppFEV1 either >= or <70%), pseudomonas airway colonisation in the 24 months prior to enrolment and treatment assignment.
...
+ Obtain an ordinal representation of the primary outcome
+ Consider re-randomisation

Given the interest in NI, assuming a dose-response perspective could be anti-conservative and is therefore not advised.
