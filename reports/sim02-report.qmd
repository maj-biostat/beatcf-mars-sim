...
Patient level heterogeneity is assumed to be multivariate normal with standard deviations `r l[[1]]$cfg$u_s0` and `r l[[1]]$cfg$u_s1` on the intercept (baseline) and slope (followup increment) respectively with `r l[[1]]$cfg$u_rho` correlation between them.
...
+ $u_{i0}$ and $u_{i1}$ are the participant level offset from the intercept and slope
...
The correlation between pre and post ppFEV1 is 
...
#| fig-cap: 'Example trial 1 accrual'
#| fig-height: 5
#| fig-width: 7
#| fig-pos: H

print(example_accrual(l_ex, id_scen))
```


```{r, echo = F, eval = T}
#| label: fig-ex1-anlys-sets
#| fig-cap: 'Example trial 1 analysis sets'
#| fig-height: 5
#| fig-width: 7
#| fig-pos: H


print(example_analysis_sets(l_ex, id_scen))
```


```{r, echo = F, eval = T}
#| label: fig-ex1-inf-cmp
#| fig-cap: 'Example trial 1 inferential framework comparison'
#| fig-height: 7
#| fig-width: 7
#| fig-pos: H


suppressWarnings(print(example_inference_cmp(l_ex, id_scen)))
```
...
#| fig-cap: 'Example trial 2 accrual'
#| fig-height: 5
#| fig-width: 7
#| fig-pos: H
...
```{r, echo = F, eval = T}
#| label: fig-ex2-anlys-sets
#| fig-cap: 'Example trial 2 analysis sets'
#| fig-height: 5
#| fig-width: 7
#| fig-pos: H
...
```{r, echo = F, eval = T}
#| label: fig-ex2-inf-cmp
#| fig-cap: 'Example trial 2 inferential framework comparison'
#| fig-height: 7
#| fig-width: 7
#| fig-pos: H
...
#| fig-cap: 'Example trial 3 accrual'
#| fig-height: 5
#| fig-width: 7
#| fig-pos: H
...
```{r, echo = F, eval = T}
#| label: fig-ex3-anlys-sets
#| fig-cap: 'Example trial 3 analysis sets'
#| fig-height: 5
#| fig-width: 7
#| fig-pos: H
